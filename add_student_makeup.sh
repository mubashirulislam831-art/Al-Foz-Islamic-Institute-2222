...
sed -i '/<!-- Main Timeline Section -->/i \
    <!-- Makeup Classes Section -->\n\
    <div class="bg-white rounded-3xl p-6 mb-8 border border-primary/10 shadow-sm relative overflow-hidden">\n\
      <h2 class="text-sm font-black text-primary uppercase tracking-widest mb-6 flex items-center gap-2"><i data-lucide="refresh-cw" class="w-4 h-4"></i> Makeup Classes</h2>\n\
      <div class="overflow-x-auto">\n\
        <table class="w-full text-left border-collapse whitespace-nowrap">\n\
          <thead>\n\
            <tr class="border-b border-primary/10 bg-slate-50/50">\n\
              <th class="p-3 text-[10px] font-extrabold text-primary/60 uppercase tracking-wider">Original Missed Date</th>\n\
              <th class="p-3 text-[10px] font-extrabold text-primary/60 uppercase tracking-wider">Makeup Date</th>\n\
              <th class="p-3 text-[10px] font-extrabold text-primary/60 uppercase tracking-wider">Teacher</th>\n\
              <th class="p-3 text-[10px] font-extrabold text-primary/60 uppercase tracking-wider text-right">Status</th>\n\
            </tr>\n\
          </thead>\n\
          <tbody class="text-xs divide-y divide-primary/5">\n\
            <?php if (empty($makeup_history)): ?>\n\
            <tr>\n\
              <td colspan="4" class="p-4 text-center text-primary/50 font-bold uppercase tracking-wider">\n\
            ...
            <?php else: ?>\n\
              ...
              <tr class="hover:bg-slate-50/50 transition-colors">\n\
                <td class="p-3 font-medium text-rose-600/80">\n\
