<?php
/**
 * Al Foz Islamic Institute - Super Admin Student Reports
 */
...
<div class="flex-grow flex flex-col min-h-screen bg-transparent">
  <div class="p-6 md:p-8 flex-grow">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
      <div>
        <h1 class="text-2xl font-extrabold text-primary">Analytical Reports Hub</h1>
        <p class="text-xs text-primary/60 mt-1">Examine and print full academic, financial, and attendance report dossiers.</p>
      </div>
    </div>

    <!-- Reports Menu Links -->
    <div class="flex flex-wrap gap-2 mb-8 text-xs font-bold">
      <a href="student_reports.php" class="bg-primary text-secondary px-4 py-2.5 rounded-xl uppercase transition-all">Seekers</a>
      ...
      <a href="attendance_reports.php" class="bg-white border border-primary/15 text-primary hover:bg-primary hover:text-secondary px-4 py-2.5 rounded-xl uppercase transition-all">Attendance</a>
    ...
    <div class="bg-white rounded-2xl border border-primary/10 shadow-sm p-6">
      <h3 class="font-bold text-primary mb-4">Seekers Report Generation</h3>
      <p class="text-xs text-primary/70">Aggregate reports, average GPA records, and enrollment summary analytics.</p>
    </div>
  </div>
