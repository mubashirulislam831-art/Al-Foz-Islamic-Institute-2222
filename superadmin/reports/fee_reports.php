<?php
/**
 * Al Foz Islamic Institute - Super Admin Fee Reports Hub
 */
...
<div class="flex-grow flex flex-col min-h-screen bg-transparent">
  <div class="p-6 md:p-8 flex-grow">
    ...
    <div class="mb-8">
      <h1 class="text-2xl font-extrabold text-primary">Fee Collection Reports</h1>
    </div>
    ...
    <div class="flex flex-wrap gap-2 mb-8 text-xs font-bold">
      ...
      <a href="fee_reports.php" class="bg-primary text-secondary px-4 py-2.5 rounded-xl uppercase transition-all">Fees</a>
    ...
    <div class="bg-white rounded-2xl border border-primary/10 shadow-sm p-6">
      <h3 class="font-bold text-primary mb-4">Fee Billings Aggregates</h3>
      <p class="text-xs text-primary/70">Analyze seeker payment dues, successful releases, and pending invoices.</p>
    </div>
  </div>
