<?php
/**
 * Al Foz Islamic Institute - Super Admin Salary Reports Hub
 */
...
<div class="flex-grow flex flex-col min-h-screen bg-transparent">
  <div class="p-6 md:p-8 flex-grow">
    ...
    <div class="mb-8">
      <h1 class="text-2xl font-extrabold text-primary">Salaries payroll Reports</h1>
    </div>
    ...
    <div class="flex flex-wrap gap-2 mb-8 text-xs font-bold">
      ...
      <a href="salary_reports.php" class="bg-primary text-secondary px-4 py-2.5 rounded-xl uppercase transition-all">Salaries</a>
    ...
    <div class="bg-white rounded-2xl border border-primary/10 shadow-sm p-6">
      <h3 class="font-bold text-primary mb-4">Salary Release Logs</h3>
      <p class="text-xs text-primary/70">Analyze instructor-wise base pays, bonus payouts, and monthly releases.</p>
    </div>
  </div>
