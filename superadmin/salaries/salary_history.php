<?php
/**
 * Al Foz Islamic Institute - Super Admin Salary History
 */
...
<div class="flex-grow flex flex-col min-h-screen bg-transparent">
  <div class="p-6 md:p-8 flex-grow">
    ...
    <div class="mb-8">
      ...
      <h1 class="text-2xl font-extrabold text-primary mt-3">Scholar Payout History</h1>
    </div>

    <div class="bg-white rounded-2xl border border-primary/10 shadow-sm p-6">
      <p class="text-xs text-primary/70">Previous disbursements for this scholar.</p>
    </div>
  </div>
