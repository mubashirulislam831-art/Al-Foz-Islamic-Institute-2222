...
<div class="flex-grow flex flex-col min-h-screen bg-transparent">
  <div class="p-6 md:p-8 flex-grow">
    ...
    <!-- Active Tab Panel: Academy Settings -->
    <div class="bg-white rounded-2xl border border-primary/10 p-6 md:p-8 shadow-sm">
      <h3 class="font-extrabold text-sm text-primary uppercase tracking-wider mb-6 pb-2 border-b border-primary/5">Academy Identity & Schedules</h3>
      <form onsubmit="event.preventDefault(); alert('Academy settings updated successfully!');" class="space-y-6 max-w-2xl text-xs">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label class="block text-[10px] uppercase font-bold tracking-wider text-primary/70 mb-2">Institute Name</label>
            <input type="text" value="Al Foz Islamic Institute" class="w-full px-4 py-3 border border-primary/10 rounded-xl focus:ring-1 focus:ring-primary focus:outline-none">
          </div>
          <div>
            <label class="block text-[10px] uppercase font-bold tracking-wider text-primary/70 mb-2">Slogan / Sub-heading</label>
            <input type="text" value="SYSTEM ADMINISTRATIVE HEADQUARTERS" class="w-full px-4 py-3 border border-primary/10 rounded-xl focus:ring-1 focus:ring-primary focus:outline-none">
          </div>
          <div>
            <label class="block text-[10px] uppercase font-bold tracking-wider text-primary/70 mb-2">Academic Year</label>
            <input type="text" value="2026-2027" class="w-full px-4 py-3 border border-primary/10 rounded-xl focus:ring-1 focus:ring-primary focus:outline-none">
          </div>
          <div>
            <label class="block text-[10px] uppercase font-bold tracking-wider text-primary/70 mb-2">Time Zone</label>
            <select class="w-full px-4 py-3 border border-primary/10 rounded-xl focus:ring-1 focus:ring-primary focus:outline-none">
              <option selected>Pakistan Standard Time (GMT+5)</option>
              <option>Saudi Arabia Standard Time (GMT+3)</option>
