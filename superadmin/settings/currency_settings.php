...
<div class="flex-grow flex flex-col min-h-screen bg-transparent">
  <div class="p-6 md:p-8 flex-grow">
    ...
    <!-- Active Tab Panel: Currency Settings -->
    <div class="bg-white rounded-2xl border border-primary/10 p-6 md:p-8 shadow-sm">
      <h3 class="font-extrabold text-sm text-primary uppercase tracking-wider mb-6 pb-2 border-b border-primary/5">Multi-Currency & Conversion Engine</h3>
      <form onsubmit="event.preventDefault(); alert('Exchange rates and defaults refreshed successfully!');" class="space-y-6 max-w-2xl text-xs">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label class="block text-[10px] uppercase font-bold tracking-wider text-primary/70 mb-2">Primary Ledger Currency</label>
          ...
          <div>
            <label class="block text-[10px] uppercase font-bold tracking-wider text-primary/70 mb-2">Base Multi-Currency Rates</label>
            <div class="space-y-2 pt-1 font-mono text-[11px] text-primary/80">
              <p>1 USD = 278.50 PKR</p>
              <p>1 SAR = 74.25 PKR</p>
              <p>1 GBP = 352.10 PKR</p>
            </div>
          </div>
        </div>
