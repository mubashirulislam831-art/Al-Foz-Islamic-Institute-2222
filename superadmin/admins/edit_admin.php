<?php
/**
 * Al Foz Islamic Institute - Super Admin Edit Admin
 */
...
<div class="flex-grow flex flex-col min-h-screen bg-transparent">
  <div class="p-6 md:p-8 flex-grow">
    ...
    <div class="mb-8">
      ...
      <h1 class="text-2xl font-extrabold text-primary mt-3">Edit Admin Credentials</h1>
    </div>
      ...
      <form action="#" method="POST" class="space-y-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" value="Sumera Tabassum" required>
          </div>
          <div class="form-group">
            <label class="form-label">Email Address</label>
            <input type="email" class="form-control" value="admin@alfoz.com" required>
          </div>
        </div>
