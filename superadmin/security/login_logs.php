...
<div class="flex-grow flex flex-col min-h-screen bg-transparent">
  <div class="p-6 md:p-8 flex-grow">
    ...
    <!-- Active Tab Panel: Login Logs -->
    <div class="bg-white rounded-2xl border border-primary/10 p-6 md:p-8 shadow-sm">
      <h3 class="font-extrabold text-sm text-primary uppercase tracking-wider mb-6 pb-2 border-b border-primary/5">Interactive System Login Logs</h3>
        ...
        <table class="w-full text-left text-xs">
          <thead>
            <tr class="border-b border-primary/10 uppercase font-bold text-primary/50 text-[10px]">
              ...
              <th class="pb-3">Browser/Agent</th>
              <th class="pb-3 text-right">Login Time</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-primary/5 text-primary/80">
            <tr>
              <td class="py-4 font-bold text-primary">admin@alfoz.com</td>
              <td class="py-4 font-mono">182.180.201.42</td>
              <td class="py-4">Lahore, Pakistan</td>
              <td class="py-4">Chrome (Windows 11)</td>
              <td class="py-4 text-right font-mono text-primary/60">2026-06-28 10:14</td>
            </tr>
            <tr>
              <td class="py-4 font-bold text-primary">teacher@alfoz.com</td>
              <td class="py-4 font-mono">39.42.181.109</td>
              <td class="py-4">Karachi, Pakistan</td>
              <td class="py-4">Safari (iOS 17.4)</td>
              <td class="py-4 text-right font-mono text-primary/60">2026-06-28 09:30</td>
            </tr>
          </tbody>
        </table>
      </div>
