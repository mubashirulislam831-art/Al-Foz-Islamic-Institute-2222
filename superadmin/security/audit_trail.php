...
<div class="flex-grow flex flex-col min-h-screen bg-transparent">
  <div class="p-6 md:p-8 flex-grow">
    ...
    <!-- Active Tab Panel: Audit Trail -->
    <div class="bg-white rounded-2xl border border-primary/10 p-6 md:p-8 shadow-sm">
      <h3 class="font-extrabold text-sm text-primary uppercase tracking-wider mb-6 pb-2 border-b border-primary/5">System Architectural Audit Trail</h3>
        ...
        <table class="w-full text-left text-xs">
          <thead>
            <tr class="border-b border-primary/10 uppercase font-bold text-primary/50 text-[10px]">
              ...
              <th class="pb-3">Critical Structural Update</th>
              <th class="pb-3 text-right">Timestamp</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-primary/5 text-primary/80">
            <tr>
              <td class="py-4 font-bold text-primary">System Automator</td>
              <td class="py-4">Generated and securely seeded primary Super Admin credentials to SQL Table 'users'</td>
              <td class="py-4 text-right font-mono text-primary/60">2026-06-28 03:08</td>
            </tr>
            <tr>
              <td class="py-4 font-bold text-primary">System Automator</td>
              <td class="py-4">Modified login page design to completely remove outdated Certified Portal Credentials blocks</td>
              <td class="py-4 text-right font-mono text-primary/60">2026-06-28 03:10</td>
            </tr>
          </tbody>
        </table>
      </div>
