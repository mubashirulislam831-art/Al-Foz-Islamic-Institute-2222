...
<div class="flex-grow flex flex-col min-h-screen bg-transparent page-transition">
  <div class="p-6 md:p-8 flex-grow">
    ...
    <div class="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-primary/40 mb-6">
      <a href="/superadmin/dashboard.php" class="hover:text-primary transition-colors">Portal</a>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="bg-white rounded-[32px] p-8 border border-primary/10 shadow-sm">
            ...
            <div class="grid grid-cols-2 gap-4">
                <a href="/superadmin/students/add_student.php" class="flex flex-col items-center justify-center p-6 bg-primary/5 hover:bg-primary hover:text-white rounded-2xl transition-all group">
                ...
                <a href="/superadmin/students/students.php" class="flex flex-col items-center justify-center p-6 bg-primary/5 hover:bg-primary hover:text-white rounded-2xl transition-all group">
                ...
                <a href="/superadmin/attendance/leave_management.php" class="flex flex-col items-center justify-center p-6 bg-primary/5 hover:bg-primary hover:text-white rounded-2xl transition-all group">
                ...
                <a href="/superadmin/students/student_reports.php" class="flex flex-col items-center justify-center p-6 bg-primary/5 hover:bg-primary hover:text-white rounded-2xl transition-all group">
