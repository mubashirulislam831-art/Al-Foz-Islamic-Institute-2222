<?php
/**
 * Al Foz Islamic Institute - Super Admin Edit Parent
 */
...
<div class="flex-grow flex flex-col min-h-screen bg-transparent">
  <div class="p-6 md:p-8 flex-grow">
    ...
    <div class="mb-8">
      ...
      <h1 class="text-2xl font-extrabold text-primary mt-3">Edit Parent Profile</h1>
    </div>
      ...
      <form action="#" method="POST" class="space-y-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div class="form-group">
            ...
            <input type="text" name="father_name" class="form-control" value="PARENT_NAME_PLACEHOLDER" required>
          </div>
          <div class="form-group">
            <label class="form-label">Email Address</label>
            <input type="email" name="email" class="form-control" value="PARENT_EMAIL_PLACEHOLDER" required>
          </div>
        </div>
        ...
        <div class="flex justify-end gap-3 pt-4 border-t border-primary/5">
          ...
          <button type="submit" class="btn-erp btn-erp-primary">Commit Changes</button>
        </div>
      </form>
    </div>
  </div>
